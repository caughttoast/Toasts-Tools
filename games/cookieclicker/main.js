...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		if (!App)
		{
			...
			Game.attachTooltip(l('topbarOrteil'),'<div style="padding:8px;width:250px;text-align:center;">Back to Toast\'s Tools!<br>Enjoy your time here!</div>'+tinyIcon([17,5],'display:block;margin:-12px auto;'),'this');
			Game.attachTooltip(l('topbarDashnet'),'<div style="padding:8px;width:250px;text-align:center;">Back to Orteil\'s homepage!</div>','this');
